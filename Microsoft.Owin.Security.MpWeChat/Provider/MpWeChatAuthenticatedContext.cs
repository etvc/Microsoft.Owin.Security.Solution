...
{
    public class MpWeChatAuthenticatedContext : BaseContext
    {
        public MpWeChatAuthenticatedContext(IOwinContext context, string openId, JObject user, string accessToken)
            : base(context)
        {
