...
{
    internal class MpWeChatAccountAuthenticationHandler : AuthenticationHandler<MpWeChatAuthenticationOptions>
    {
        ...
        public MpWeChatAccountAuthenticationHandler(HttpClient httpClient, ILogger logger)
        {
        ...
        private async Task<bool> InvokeReturnPathAsync()
        {
            ...
            var context = new MpWeChatReturnEndpointContext(Context, model);
        ...
        protected override async Task<AuthenticationTicket> AuthenticateCoreAsync()
        {
            ...
            try
            {
                ...
                var context = new MpWeChatAuthenticatedContext(Context, tokenResult.openid, userInfo, tokenResult.access_token);
